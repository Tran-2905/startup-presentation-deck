...
export const PortersSlide: React.FC<SlideProps> = () => (
  <div className="w-full h-full flex flex-col items-center justify-center p-4">
    <h3 className="text-5xl md:text-6xl font-bold text-white mb-8 tracking-wide drop-shadow-2xl">
      Porter's Five Forces Analysis
    </h3>
    
    <div className="w-full max-w-7xl h-full max-h-[85vh] grid grid-cols-1 md:grid-cols-3 gap-x-16 gap-y-8">
            
        {/* Left Column: Suppliers */}
        <div className="md:col-start-1 flex flex-col justify-center relative">
                <div className="bg-emerald-900/30 border border-emerald-500/40 p-8 rounded-xl shadow-lg relative z-10 hover:border-emerald-400 transition-colors">
                    <div className="flex items-center gap-3 mb-4 border-b border-emerald-500/30 pb-3">
                        <Users size={32} className="text-emerald-400" />
                        <div className="flex-1">
                            <h4 className="font-bold text-white text-xl">Suppliers</h4>
                        </div>
                        <span className="text-xs font-bold text-emerald-900 bg-emerald-400 px-3 py-1 rounded-full">LOW</span>
                    </div>
                ...
                {/* Arrow to Center */}
                <div className="absolute top-1/2 -right-16 -translate-y-1/2 text-slate-500/80 z-0 hidden md:block">
                     <ArrowRight size={80} strokeWidth={1} />
                </div>
        </div>

        {/* Middle Column: Entrants (Top), Rivalry (Center), Substitutes (Bottom) */}
        <div className="md:col-start-2 flex flex-col justify-center gap-14 h-full py-2">
            
            {/* Top: New Entrants */}
                <div className="bg-blue-900/30 border border-blue-500/40 p-6 rounded-xl shadow-lg relative hover:border-blue-400 transition-colors">
                    <div className="flex items-center gap-3 mb-3 border-b border-blue-500/30 pb-2">
                        <ShieldCheck size={28} className="text-blue-400" />
                        <div className="flex-1">
                            <h4 className="font-bold text-white text-lg">New Entrants</h4>
                        </div>
                        <span className="text-xs font-bold text-blue-900 bg-blue-400 px-2 py-0.5 rounded-full">MODERATE</span>
                    </div>
                    ...
                    {/* Down Arrow */}
                    <div className="absolute -bottom-14 left-1/2 -translate-x-1/2 text-slate-500/80 hidden md:block">
                        <ArrowDown size={64} strokeWidth={1} />
                    </div>
                </div>

                {/* Center: Rivalry */}
                <div className="bg-red-900/40 border-2 border-red-500 p-8 rounded-2xl shadow-[0_0_40px_rgba(220,38,38,0.3)] z-20 relative">
                    <div className="flex flex-col items-center text-center mb-6">
                        <h4 className="font-extrabold text-white text-3xl tracking-tight uppercase drop-shadow-lg">Competitive Rivalry</h4>
                        <span className="text-sm font-bold text-white bg-red-600 px-6 py-1.5 rounded-full shadow-lg mt-3 border border-red-400">INTENSITY: MODERATE</span>
                    </div>
                    <ul className="space-y-4 text-base text-slate-100 text-left">
                        <li className="flex gap-3 items-start">
                            <CheckCircle2 size={24} className="text-red-400 mt-0.5 shrink-0" />
                ...
                {/* Bottom: Substitutes */}
                <div className="bg-purple-900/30 border border-purple-500/40 p-6 rounded-xl shadow-lg relative hover:border-purple-400 transition-colors">
                    {/* Up Arrow */}
                    <div className="absolute -top-14 left-1/2 -translate-x-1/2 text-slate-500/80 hidden md:block">
                        <ArrowUp size={64} strokeWidth={1} />
                    </div>
                    <div className="flex items-center gap-3 mb-3 border-b border-purple-500/30 pb-2">
                        <BrainCircuit size={28} className="text-purple-400" />
                        <div className="flex-1">
                            <h4 className="font-bold text-white text-lg">Substitutes</h4>
                        </div>
                        <span className="text-xs font-bold text-purple-900 bg-purple-400 px-2 py-0.5 rounded-full">LOW</span>
                    </div>
                    <ul className="space-y-2 text-sm text-slate-200">
                        <li className="flex gap-2">
        ...
        {/* Right Column: Buyers */}
            <div className="md:col-start-3 flex flex-col justify-center relative">
                <div className="absolute top-1/2 -left-16 -translate-y-1/2 text-slate-500/80 z-0 hidden md:block">
                     <ArrowLeft size={80} strokeWidth={1} />
                </div>
                <div className="bg-orange-900/30 border border-orange-500/40 p-8 rounded-xl shadow-lg relative z-10 hover:border-orange-400 transition-colors">
                    <div className="flex items-center gap-3 mb-4 border-b border-orange-500/30 pb-3">
                        <Wallet size={32} className="text-orange-400" />
                        <div className="flex-1">
                            <h4 className="font-bold text-white text-xl">Buyers</h4>
                        </div>
                        <span className="text-xs font-bold text-orange-900 bg-orange-400 px-3 py-1 rounded-full">MODERATE</span>
                    </div>
                    <ul className="space-y-4 text-base text-slate-200">
                        <li className="flex gap-2">
...
// --- Slide 13: Market Pains vs Solutions ---
export const MarketPainsSlide: React.FC<SlideProps> = () => {
    return (
        <div className="w-full flex flex-col h-full">
            {/* Header */}
            <div className="mb-4 text-center shrink-0">
                <h3 className="text-4xl font-bold text-white mb-2">Market Pains & Strategic Solutions</h3>
                <p className="text-teal-400 text-xl">Directly addressing the "Trust & Performance" crisis</p>
            </div>
            ...
            <div className="flex-1 w-full min-h-0 overflow-y-auto custom-scrollbar p-2">
                <div className="space-y-4 max-w-6xl mx-auto">
                    ...
                    {/* Row 1: Trust & Verification */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                         {/* Pain */}
                         <div className="bg-red-900/20 border-l-4 border-red-500 rounded-r-xl p-4 flex items-start gap-4">
                             <div className="p-3 bg-red-900/50 rounded-lg text-red-400 shrink-0">
                                 <FileWarning size={24} />
                             </div>
                             <div>
                                 <h4 className="text-lg font-bold text-red-100">Trust & Verification Pain</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     Traditional models rely on manual photo uploads prone to <span className="text-white font-bold">"fake diploma" fraud</span>.
                                 </p>
                             </div>
                         </div>
                         {/* Solution */}
                         <div className="bg-teal-900/20 border-l-4 border-teal-500 rounded-r-xl p-4 flex items-start gap-4">
                             <div className="p-3 bg-teal-900/50 rounded-lg text-teal-400 shrink-0">
                                 <ScanFace size={24} />
                             </div>
                             <div>
                                 <h4 className="text-lg font-bold text-teal-100">Solution A: "Trust Stack"</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     Multi-layer verification via AI OCR and <span className="text-white font-bold">eKYC NFC</span>. Mandatory 80% subject-test threshold ensures a "Quality Floor".
                                 </p>
                             </div>
                         </div>
                    </div>

                    {/* Row 2: Financial Safety */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                         {/* Pain */}
                         <div className="bg-red-900/20 border-l-4 border-red-500 rounded-r-xl p-4 flex items-start gap-4">
                             <div className="p-3 bg-red-900/50 rounded-lg text-red-400 shrink-0">
                             ...
                             <div>
                                 <h4 className="text-lg font-bold text-red-100">Financial Safety Pain</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     Parents forced into risky <span className="text-white font-bold">100% upfront payments</span>. Tutors exploited by 40-50% commissions without guarantees.
                                 </p>
                             </div>
                         </div>
                         {/* Solution */}
                         <div className="bg-teal-900/20 border-l-4 border-teal-500 rounded-r-xl p-4 flex items-start gap-4">
                             ...
                             <div>
                                 <h4 className="text-lg font-bold text-teal-100">Solution B: "Financial Protection"</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     "Partner-First" Escrow strategy (BaaS). <span className="text-white font-bold">50% deposit held</span> in bank-locked account, offering maximum security.
                                 </p>
                             </div>
                         </div>
                    </div>

                    {/* Row 3: Price Transparency & Compliance */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                         {/* Pain */}
                         <div className="bg-red-900/20 border-l-4 border-red-500 rounded-r-xl p-4 flex items-start gap-4">
                             <div className="p-3 bg-red-900/50 rounded-lg text-red-400 shrink-0">
                             ...
                             <div>
                                 <h4 className="text-lg font-bold text-red-100">Price Transparency Pain</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     Hidden costs and high fees drive price wars that compromise quality.
                                 </p>
                             </div>
                         </div>
                         {/* Solution */}
                         <div className="bg-teal-900/20 border-l-4 border-teal-500 rounded-r-xl p-4 flex items-start gap-4">
                             ...
                             <div>
                                 <h4 className="text-lg font-bold text-teal-100">Solution E: Partnership & Compliance</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     Ensures 100% alignment with <span className="text-white font-bold">Circular 29/2024</span> by automating fee disclosure and registration.
                                 </p>
                             </div>
                         </div>
                    </div>

                    {/* Row 4: Outcome Visibility */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                         {/* Pain */}
                         <div className="bg-red-900/20 border-l-4 border-red-500 rounded-r-xl p-4 flex items-start gap-4">
                             <div className="p-3 bg-red-900/50 rounded-lg text-red-400 shrink-0">
                             ...
                             <div>
                                 <h4 className="text-lg font-bold text-red-100">Outcome Visibility Pain</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     Parents feel "Time Poverty" and lack evidence of progress beyond subjective reports.
                                 </p>
                             </div>
                         </div>
                         {/* Solution */}
                         <div className="bg-teal-900/20 border-l-4 border-teal-500 rounded-r-xl p-4 flex items-start gap-4">
                             ...
                             <div>
                                 <h4 className="text-lg font-bold text-teal-100">Solution C: "Outcome System"</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     "Learning Infrastructure" with AI longitudinal performance reports. Creates <span className="text-white font-bold">Data Lock-in</span> moat.
                                 </p>
                             </div>
                         </div>
                    </div>

                    {/* Row 5: Operational Friction */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                         {/* Pain */}
                         <div className="bg-red-900/20 border-l-4 border-red-500 rounded-r-xl p-4 flex items-start gap-4">
                             <div className="p-3 bg-red-900/50 rounded-lg text-red-400 shrink-0">
                             ...
                             <div>
                                 <h4 className="text-lg font-bold text-red-100">Operational Friction Pain</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     Fragmented communication (Zalo, phone, cash) leads to frequent no-shows and disputes.
                                 </p>
                             </div>
                         </div>
                         {/* Solution */}
                         <div className="bg-teal-900/20 border-l-4 border-teal-500 rounded-r-xl p-4 flex items-start gap-4">
                             ...
                             <div>
                                 <h4 className="text-lg font-bold text-teal-100">Solution D: "Operations"</h4>
                                 <p className="text-sm text-slate-400 mt-1">
                                     Automates admin tasks (scheduling, invoices). Reduces admin time by <span className="text-white font-bold">5 hours/week</span>.
                                 </p>
                             </div>
                         </div>
                    </div>
